...
public class CreateNR2 {
	private static final String DB_PATH = "C:/dev_convert/neo4j-community-2.0.0-M02/data/graph.db";

	// postgres
	private static Connection conn;
	
	ArrayList<String> array_part = new ArrayList<String>();
	ArrayList<String> array_name = new ArrayList<String>();
	ArrayList<String> array_oprice = new ArrayList<String>();
	ArrayList<String> array_sprice = new ArrayList<String>();
...
/////////////// convert_start - sex ----- 2
			...
			for (int i = 0; i < array_part.size(); i++) {
				System.out.println(array_part.get(i));

				// 먼저 기존에 존재하는 노드인지 확인
				String check_name = array_part.get(i);
...
/////////////// convert_start - job ----- 3
			...
			for (int i = 0; i < array_oprice.size(); i++) {
				System.out.println(array_oprice.get(i));

				// 먼저 기존에 존재하는 노드인지 확인
				String check_name = array_oprice.get(i);
...
/////////////// convert_start - job ----- 4
			...
			for (int i = 0; i < array_sprice.size(); i++) {
				System.out.println(array_sprice.get(i));

				// 먼저 기존에 존재하는 노드인지 확인
				String check_name = array_sprice.get(i);
...
/////////////// convert_start
			...
			for (int i = 0; i < array_name.size(); i++) {
				...
				// end node
				String end_node = array_part.get(i);

				// rel type
				String rel_type = "part";
...
/////////////// convert_start
			...
			for (int i = 0; i < array_name.size(); i++) {
				...
				// end node
				String end_node = array_oprice.get(i);

				// rel type
				String rel_type = "oprice";
...
/////////////// convert_start
			...
			for (int i = 0; i < array_name.size(); i++) {
				...
				// end node
				String end_node = array_sprice.get(i);

				// rel type
				String rel_type = "sprice";
...
//		System.out.println("");
		...
		while (rs.next()) {
			...
			array_part.add(rs.getString("g_part"));
			array_name.add(rs.getString("g_name"));
			array_oprice.add(rs.getString("g_origin_price"));
			array_sprice.add(rs.getString("g_sell_price"));
