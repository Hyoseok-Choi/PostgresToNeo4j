...
public class CreateNR3 {
	private static final String DB_PATH = "C:/dev_convert/neo4j-community-2.0.0-M02/data/graph.db";

	// postgres
	private static Connection conn;
	
	ArrayList<String> array_b_name = new ArrayList<String>();
	ArrayList<String> array_p_name = new ArrayList<String>();
	ArrayList<String> array_b_date = new ArrayList<String>();
	ArrayList<String> array_b_time = new ArrayList<String>();
...
// ///////////// convert_start - name ----- 1
			...
			for (int i = 0; i < array_b_name.size(); i++) {
				System.out.println(array_b_name.get(i));

				// 먼저 기존에 존재하는 노드인지 확인
				String check_name = array_b_name.get(i);
...
/////////////// convert_start - sex ----- 2
			...
			for (int i = 0; i < array_p_name.size(); i++) {
				System.out.println(array_p_name.get(i));

				// 먼저 기존에 존재하는 노드인지 확인
				String check_name = array_p_name.get(i);
...
/////////////// convert_start - job ----- 3
			...
			for (int i = 0; i < array_b_date.size(); i++) {
				System.out.println(array_b_date.get(i));

				// 먼저 기존에 존재하는 노드인지 확인
				String check_name = array_b_date.get(i);
...
/////////////// convert_start - job ----- 4
			...
			for (int i = 0; i < array_b_time.size(); i++) {
				System.out.println(array_b_time.get(i));

				// 먼저 기존에 존재하는 노드인지 확인
				String check_name = array_b_time.get(i);
...
/////////////// convert_start
			...
			for (int i = 0; i < array_b_name.size(); i++) {
				...
				// start node
				String start_node = array_b_name.get(i);

				// end node
				String end_node = array_p_name.get(i);

				// rel type
				String rel_type = "buy_goods";
...
/////////////// convert_start
			...
			for (int i = 0; i < array_b_name.size(); i++) {
				...
				// end node
				String end_node = array_b_date.get(i);

				// rel type
				String rel_type = "buy_date";
...
/////////////// convert_start
			...
			for (int i = 0; i < array_b_name.size(); i++) {
				...
				// end node
				String end_node = array_b_time.get(i);

				// rel type
				String rel_type = "buy_time";
...
//		System.out.println("");
		...
		while (rs.next()) {
			...
			array_b_name.add(rs.getString("b_name"));
			array_p_name.add(rs.getString("p_name"));
			array_b_date.add(rs.getString("b_date"));
			array_b_time.add(rs.getString("b_time"));
...
//		rs.close();
	...
	System.out.println(array_b_name.size());
